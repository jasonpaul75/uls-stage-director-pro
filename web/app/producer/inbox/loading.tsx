...
export default function ProducerInboxLoading() {
  return (
    <AppShell id="producer-main-content" outerMaxWidth="wide" contentMaxWidth="full" className="pt-10">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0 space-y-2">
          <Skeleton className="h-3 w-24 rounded-md" />
          <Skeleton className="h-9 w-[min(18rem,100%)] max-w-full rounded-lg" />
          <Skeleton className="h-[4.75rem] w-full max-w-prose rounded-lg" />
        </div>
            ...
            <ProducerGlassCard as="div" padding="compact">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0 flex-1 space-y-2">
                  <Skeleton className="h-5 w-[min(16rem,100%)] rounded-md" />
